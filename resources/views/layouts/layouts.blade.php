                    ...
                    <div id="mnu-registro"
                        ...
                        @if (Route::has('login'))
                            <div class="flex flex-col justify-end  sm:text-sm md:text-md lg:text-xl text-gray-600">
                                ...
                                @else
                                    <div class="h-auto flex flex-col space-y-2">
                                        <a href="{{ route('login') }}"
                                        ...
                                        @if (Route::has('register'))
                                            <a href="{{ route('register') }}"
                                                class="rounded-md px-3 py-1 ring-1 ring-transparent transition  hover:text-black/70 hover:bg-gray-200 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                                                Registrese
                                            </a>
                                        @endif
                                    </div>
